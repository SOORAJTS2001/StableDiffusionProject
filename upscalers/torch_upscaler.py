...
device = 'cpu'
result_path = os.getcwd() + '/tests-upscaled.png'
img = '/Users/u254428/PycharmProjects/diffusionbee-stable-diffusion-ui/backends/upscale_image/generated_image.jpg'
backend = 'GPU'
...
def prepare_AI_model(AI_model, device):
    ...
    model_path = (r"/Users/u254428/PycharmProjects/diffusionbee-stable-diffusion-ui/BSRGAN.pth")
